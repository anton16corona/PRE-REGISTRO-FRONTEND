...
export class ConvocatoriaGuardiaAuxiliar extends LitElement {
  static styles = css`
    :host {
      display: block;
      min-height: 100vh;
      ...
      <main>
        <section class="hero">
          ...
          <div class="content">
            ...
            <p class="phrase">
              ¡Forma parte de nuestro cuerpo de Guardia Auxiliar!
            </p>

            <p class="info">
              Personal de apoyo para realizar acciones de custodia, vigilancia y seguridad en espacios públicos o 
              privados, con el objetivo de prevención y protección a la ciudadanía.
            </p>
