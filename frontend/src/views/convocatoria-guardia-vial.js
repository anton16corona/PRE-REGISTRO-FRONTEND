...
export class ConvocatoriaGuardiaVial extends LitElement {
  static styles = css`
    :host {
      display: block;
      min-height: 100vh;
      ...
      <main>
        <section class="hero">
          ...
          <div class="content">
            ...
            <p class="phrase">
              ¡Forma parte de nuestro cuerpo de Guardia Vial!
            </p>

            <p class="info">
              Personal de apoyo para promover el cumplimiento de los reglamentos de vialidad y tránsito, 
              así como la aplicación de infracciones correspondientes ante un incumplimiento en la materia.
            </p>
