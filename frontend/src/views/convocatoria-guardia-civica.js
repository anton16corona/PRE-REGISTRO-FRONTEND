...
export class ConvocatoriaGuardiaCivica extends LitElement {
static styles = css`
    :host {
      display: block;
      min-height: 100vh;
  ...
  goBack() {
    globalThis.location.href = '/perfiles-guardias';
  }
    ...
    return html`
      ...
      <main>
        <section class="hero">
          ...
          <pdf-zoom-viewer 
            pdfUrl="/convocatoria/convocatoria-guardia.pdf"
          ></pdf-zoom-viewer>
          ...
          <div class="content">
            ...
            <p class="info">
              Personal de apoyo para la promoción de la cultura cívica y civilidad, mantener la convivencia y 
              tranquilidad comunitarias, mediante la aplicación de los reglamentos en la materia y justicia cívica, 
              con enfoque en la justicia cotidiana para la resolución de conflictos a través de mecanismos 
              alternativos y la celebración de convenios y acuerdos con la ciudadanía, en los términos de la 
